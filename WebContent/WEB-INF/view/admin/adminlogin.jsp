...
<style type="text/css">
.submitbutton {
	background: url(<%= request.getContextPath ()%>/resources/images/Login_Button.jpg)
		no-repeat;
	cursor: pointer;
	border: none;
}
...
<body>
	...
	<form:form commandName="admin" action="adminlogin.html">
		<div>
			<table style="padding-left: 10px; margin-left: 275px; margin-top: 45px; background: url(<%=request.getContextPath()%>/resources/images/Login_Form_Admin.png) no-repeat;" height="225px;" width="410px">
				<tr style="height: 70px;">
					<td colspan="2">&nbsp;</td>
					<td align="left" rowspan="6" valign="middle"><input type="submit" value="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" class="submitbutton" style="height: 70px; width: 70px;" /></td>
				</tr>
				<tr style="height: 30px;">
					<td align="right" width="125px;"><form:label path="adminEmail">
							<font color="white" face="verdana" size="2.9">Admin Email:</font>
						</form:label></td>
					<td><form:input path="adminEmail" size="20" /></td>
				</tr>
				<tr style="height: 15px;">
					<td></td>
					<td><FONT color="red"><form:errors path="adminEmail"></form:errors></FONT></td>
				</tr>
				<tr style="height: 30px;">
					<td align="right"><form:label path="password">
							<font color="white" face="verdana" size="2.9">Password:</font>
						</form:label></td>
